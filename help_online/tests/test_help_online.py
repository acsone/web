...
class TestHelpOnline(TestWizardCommon, common.TransactionCase):
    def test_get_page_url(self):
        ...
        with mock.patch.object(website.__class__, "search_pages") as search_pages:
            ...
            self.assertDictEqual(
                {
                    ...
                    "url": "website/add/help-res-partner",
                },
                info,
            ...
            self.assertTrue(user.has_group("help_online.help_online_group_reader"))
            info = help_online.get_page_url(model, "form")
            self.assertDictEqual(
                {
                    "exists": True,
                    "title": "Help on Partner",
                    "url": "pages/help-res-partner#form",
                },
                info,
